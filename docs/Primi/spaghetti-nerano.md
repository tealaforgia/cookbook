...
??? abstract inline end "Info"
    ...
    | :lucide-clock-fading:{ title="Tempo di preparazione" } | `40min` |
...
| :-- | :-- |
| :fontawesome-regular-square: `≈400g` | Spaghetti |
| :fontawesome-regular-square: `≈180g` | Provolone del Monaco[^1] |
| :fontawesome-regular-square: `≈650g` | Zucchine |
...
[^1]: Caciocavallo podolico; Provolone a media stagionatura leggermente piccante